...
# 节假日列表，需要定期更新以保证 is_holiday 特征准确
# 包含 2023-2026 年主要中国节假日
HOLIDAYS = [
    # 2023
    '2023-12-25', '2023-12-26',  # 圣诞节
    '2023-12-30', '2023-12-31',  # 元旦前
    # 2024
    '2024-01-01',  # 元旦
    ...
    '2025-10-01', '2025-10-02', '2025-10-03', '2025-10-04', '2025-10-05', '2025-10-06', '2025-10-07', '2025-10-08',  # 中秋+国庆
    # 2026
    '2026-01-01',  # 元旦
...
def run(
    ...
    # 创建一个新列，判断日期是否为节假日
    df['is_holiday'] = df['time'].dt.normalize().isin(HOLIDAYS_DT).astype(int)
